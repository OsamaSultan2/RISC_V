...
module control_register(
  ...
  output reg       reg_Write_out, mem_write_out, jump_out,
  output reg       branch_out, ALU_src_out,branch_neq_out,
  output reg [1:0] result_source_out,
  output reg [1:0] imm_src_out,
